...
def load_all_data():
    ...
    sheet_names = ['math', 'guava', 'guice', 'gumtree', 'jedis', 'commons-io', 'commons-imaging', 'commons-pool', 'gson',
                   'httpcomponents-client', 'commons-email', 'mockito', 'closure-compiler', 'commons-text', 'joda-time']
...
if __name__ == "__main__":
    ...
    with open("data/v5_10-folds.json", "w") as f:
