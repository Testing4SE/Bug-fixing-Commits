...
def parse_args():
    ...
    # data arguments
    parser.add_argument('--data', default='commit_data/',
                        help='path to dataset')
    parser.add_argument('--log', default='commit_log/',
                        help='path to dataset')
    parser.add_argument('--glove', default='commit_data/glove/',
                        help='directory with GLOVE embeddings')
    parser.add_argument('--save', default='commit_checkpoints/',
